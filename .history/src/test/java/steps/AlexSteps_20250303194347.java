...
public class AlexSteps {
    ...
    @Then("^(?:I|The User|The Client) can validate the option in the  page$")
    ...
    public void ejemplosAlex() {

        String valorEsperado = "Barcelona";
        ...
        Assert.assertTrue(valorEncontrado.contains(valorEsperado));
